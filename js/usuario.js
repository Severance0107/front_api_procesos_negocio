...
function verModificarCategoria(id){
    ...
    fetch(urlApi+"/categoria/id/"+id,settings)
    .then(response => response.json())
    .then(function(categoria){
            ...
            if(categoria){                
                ...
                <form action="" method="post" id="myForm">
                    ...
                    <label for="nombre" class="form-label">Nombre</label>
                    <input type="text" class="form-control" name="nombre" id="nombre" value="${categoria.nombre}" required> <br>
                    
                    <label for="descripcion"  class="form-label">Descripcion</label>
                    <input type="text" class="form-control" name="descripcion" id="descripcion" value="${categoria.descripcion}" required> <br>
...
function verCategoria(id){
    ...
    .then(function(usuario){
            ...
            if(usuario){                
                cadena = `
                <div class="p-3 mb-2 bg-light text-dark">
                    <h1 class="display-5"><i class="fa-solid fa-user-pen"></i> Ver Categoria</h1>
                </div>
